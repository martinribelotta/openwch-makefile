...
__WEAK void hid_in_callback(int ep, int nbytes)
{
}

__WEAK void hid_out_callback(int ep, const uint8_t *buffer, int nbytes)
{
}
...
static void usbd_hid_custom_out_callback(uint8_t ep, uint32_t nbytes)
{
    ...
    hid_out_callback(ep, read_buffer, nbytes);
}
